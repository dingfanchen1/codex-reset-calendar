...
- 收尾清空准备：2026-09-11 17:57 生成零事件测试日历；本地测试 ICS 恢复为 SHA-256 `67873ac6a63c21f868703e23b298c4abbf4f8cb0964281308d69f74d261aa889`，生产 ICS 本地字节不变。
- 当前边界：S4 要求的全部 iPhone 实机证据已经取得；发布并核对收尾空测试日历后完成阶段交接。
