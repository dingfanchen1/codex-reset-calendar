...
- 双提醒事件准备：用户选择北京时间 2026-09-11 16:58；在 02:33 生成 `sourceId=s4-notification-3`，对应 UTC `2026-09-11T08:58:00Z`，距事件约 14 小时 25 分钟。产物只有一个新 UID、`SEQUENCE=0`，并含 `TRIGGER:-PT15M` 与 `TRIGGER:PT0S`；测试 ICS SHA-256 为 `5177c11f82f3ef7c51e5f355427573d26d7ab16771a821da412e564ba3a440f5`，生产 ICS 本地字节不变。
- 当前边界：生产订阅、初始可见性、同 UID 改期、新 UID 替换和清空已有实机证据；双提醒事件待发布，提前 15 分钟与到点两次实际通知仍待验收。
