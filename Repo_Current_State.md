...
- S4：实机验收进行中；生产订阅、改期、替换和清空已通过，剩余提前 15 分钟与到点两次实际通知。
...
- 公开发布：完成；iPhone 实机验证：部分通过，改期、替换和清空已通过，双提醒待验收。
...
确认手机在 16:43 之前已自动同步北京时间 2026-09-11 16:58 的独立测试事件，随后分别记录 16:43 和 16:58 的实际通知。
