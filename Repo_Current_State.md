...
- S4：实机验收进行中；生产订阅、改期、替换、清空和双提醒事件提前同步已通过，剩余提前 15 分钟与到点两次实际通知。
...
- 公开发布：完成；iPhone 实机验证：部分通过，改期、替换、清空和双提醒事件提前同步已通过，两次实际通知待验收。
...
分别记录北京时间 2026-09-11 16:43 的提前 15 分钟通知和 16:58 的到点通知。
